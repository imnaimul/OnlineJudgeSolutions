...
/*  
** Check if the diagonals have the same letter 
...
/*  
** Check if the x, y cordiante belongs to a diagonal
** @params : int, int, int
*/
...
/*  
** Check if the all the positions except the diagonals are same
** @params : vector<vector<int> >
*/
